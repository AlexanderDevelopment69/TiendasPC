...
public class Modal extends StackPane {
    ...
    @FXML
    private MFXLegacyComboBox<String> cbRol;
    ...
    public void addElementRol(String elemento) {
        cbRol.getItems().add(elemento);
    }

    // Método para obtener el valor seleccionado y retornarlo
    public String getValueSelectedRol() {
    ...
    public void configureModal(String nameRol,  EventHandler<ActionEvent> confirmButtonAction, EventHandler<ActionEvent> cancelButtonAction) {
        cbRol.setValue(nameRol);
