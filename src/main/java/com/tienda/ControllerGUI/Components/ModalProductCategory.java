...
public class ModalProductCategory extends StackPane{
    ...
    @FXML
    private MFXTextField txtCategoryName;
    ...
    public ModalProductCategory() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/tienda/components/ModalProductCategory.fxml"));
